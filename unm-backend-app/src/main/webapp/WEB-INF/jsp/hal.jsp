...
<![endif]--> <jsp:include page="div-entered.h.jsp"></jsp:include><input type="hidden"> <div class="container"> <!--
      ...
      --> <div ng-view=""></div> </div> <div id="alert-global" class="alert alert-global" role="alert"></div> <div id="dialog-global" class="modal delete"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <a href="#" class="close" data-dismiss="modal"></a> <h3 id="dialog-title">Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ð¾Ð±ÑŠÐµÐºÑ‚</h3> </div> <div class="modal-body"> <div id="dialog-body" class="modal-body-inner"> Ð’Ñ‹ ÑƒÐ²ÐµÑ€ÐµÐ½Ñ‹? </div> </div> <div class="modal-footer"> <button id="dialog-global-btn-ok" class="btn btn-primary primary">Supprimmer</button> <button id="dialog-global-btn-cancel" class="btn btn-secondary secondary">Annuler</button> </div> </div> </div> </div> <!--[if lt IE 9]>
<script src="${baseUrl}js/oldieshim.76f279db.js"></script>
<![endif]--> <script src="${baseUrl}js/vendor.b581e0ee.js"></script> <script src="${baseUrl}js/scripts.76f2096f.js"></script> <script type="text/javascript" src="${baseURL}/js/jquery-ui-1.11.1.min.js"></script> <jsp:include page="js-adminMenu.h.jsp"></jsp:include> <script>// DO NOT REMOVE THIS</script>