...
public class SessionClientFromLocalTest {
	...
	public void setUp() throws Exception {
		...
		LogQueueDbImpl.setPrincipal(null); // "crezvani");
	}
	...
	public void test_login_OK() throws Exception {
		...
		assertEquals(1, user.getShibbolethRemoteUsers().length);

		assertEquals("crezvani@univ-paris1.fr",
				user.getShibbolethRemoteUsers()[0]);
	}
}