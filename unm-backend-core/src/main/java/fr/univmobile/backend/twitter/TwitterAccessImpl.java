...
abstract class TwitterAccessImpl implements TwitterAccess {

	protected TwitterAccessImpl() {
	...
	private static final Log log = LogFactory.getLog(TwitterAccessImpl.class);
