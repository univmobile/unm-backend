...
CP="${CP}:${M2_REPO}/org/apache/commons/commons-lang3/3.1/commons-lang3-3.1.jar"
...
java -cp "${CP}" fr.univmobile.backend.sysadmin.Main comment \
	-dburl jdbc:mysql://localhost/toto -dbusername root -dbpassword $@
