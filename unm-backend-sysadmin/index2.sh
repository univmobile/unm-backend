...
CP=
CP="${CP}:${HOME}/project/dev/unm-backend/unm-backend-sysadmin/target/classes"
CP="${CP}:${HOME}/project/dev/unm-backend/unm-backend-core/target/classes"
CP="${CP}:${HOME}/project/dev/unm-backend/unm-commons-datasource/target/classes"
CP="${CP}:${HOME}/project/dev/avc-binding-dom/target/classes"
CP="${CP}:${HOME}/project/dev/avc-binding-common/target/classes"
CP="${CP}:${HOME}/project/dev/avc-binding-yaml/target/classes"
CP="${CP}:${HOME}/project/dev/avc-commons-lang/target/classes"
...
java -cp "${CP}" fr.univmobile.backend.sysadmin.Main index \
	-data /var/univmobile -dburl jdbc:mysql://localhost/univmobile \
